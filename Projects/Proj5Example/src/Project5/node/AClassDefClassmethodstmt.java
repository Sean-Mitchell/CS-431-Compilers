...
public final class AClassDefClassmethodstmt extends PClassmethodstmt
{
    private TClassLit _classLit_;
    private TId _id_;
    private TLcurly _lcurly_;
    private PMethodstmtseqs _methodstmtseqs_;
    private TRcurly _rcurly_;

    public AClassDefClassmethodstmt()
    {
        // Constructor
    }

    public AClassDefClassmethodstmt(
        @SuppressWarnings("hiding") TClassLit _classLit_,
    ...
    public Object clone()
    {
        return new AClassDefClassmethodstmt(
            cloneNode(this._classLit_),
            cloneNode(this._id_),
    ...
    {
        ((Analysis) sw).caseAClassDefClassmethodstmt(this);
    }

    public TClassLit getClassLit()
    {
        return this._classLit_;
    }

    public void setClassLit(TClassLit node)
    {
        if(this._classLit_ != null)
        {
            this._classLit_.parent(null);
        }
    ...
    {
        // Remove child
        if(this._classLit_ == child)
        {
            this._classLit_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._classLit_ == oldChild)
        {
            setClassLit((TClassLit) newChild);
            return;
        }
